...
public class KafkaContainerTest {
    ...
    private static final DockerImageName kafkaImage = DockerImageName.parse("confluentinc/cp-kafka:8.3.1"); 
    
    @ClassRule
    public static KafkaContainer kafka = new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:8.3.1"));

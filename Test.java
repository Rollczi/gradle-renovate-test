...
public class KafkaContainerTest {
    ...
    private static final DockerImageName kafkaImage = DockerImageName.parse("confluentinc/cp-kafka:8.2.0"); 
    
    @ClassRule
    public static KafkaContainer kafka = new KafkaContainer(DockerImageName.parse("confluentinc/cp-kafka:8.2.0"));
